...
def retinanetDetection(videoPath):
    ...
    modelPath = os.path.join('snapshots', 'inference.h5')
...
if __name__ == '__main__':
    out, csvOut = retinanetDetection('D:\Marc\Documents\egh455\\training\data\Shark_whale - Evans 2016.11.18 F1 (2).MP4')
    out.release()
